...
export default function Navigation() {
  ...
  useEffect(() => {
    ...
    setMarqueeContent([
      "🚀 Get 10% off your order by WW10 🚀",
      "🚀 Free shipping on Perfume 🚀",
      "🚀 Get 10% off your order by WW10 🚀",
      "🚀 Free shipping on Perfume 🚀",
      "🚀 Get 10% off your order by WW10 🚀",
      "🚀 Free shipping on Perfume 🚀",
  ...
  // Get the first 3 categories for main nav, rest for dropdown
  const mainCategories = categories.slice(0, 3);
  const dropdownCategories = categories.slice(3);

  return (
    <>
      <div className="bg-black text-white overflow-hidden whitespace-nowrap py-2 sticky top-0 z-50">
        <div
          ref={marqueeRef}
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-12">
              ...
              {dropdownCategories.length > 0 && (
                <DropdownMenu>
                  <DropdownMenuTrigger className="flex items-center text-gray-700 hover:text-gray-900 focus:outline-none">
